...
function createRouterFromPayload({
  ...
  _chunkCHS2ANMWjs.populateRSCRouteModules.call(void 0, globalVar.__reactRouterRouteModules, payload.matches);
  ...
  globalVar.__reactRouterDataRouter = _chunkJ67PDNFMjs.createRouter.call(void 0, {
    ...
    hydrationData: _chunkCHS2ANMWjs.getHydrationData.call(void 0, {
      state: {
...
function createRouteFromServerManifest(match, payload) {
  ...
  _chunkCHS2ANMWjs.populateRSCRouteModules.call(void 0, window.__reactRouterRouteModules, match);
  let dataRoute = {
    id: match.id,
...
function normalizeRedirectLocation(location2) {
  if (_chunkJ67PDNFMjs.PROTOCOL_RELATIVE_URL_REGEX.test(location2)) {
    let path = _chunkJ67PDNFMjs.resolvePath.call(void 0, location2);
