...
function createRouterFromPayload({
  ...
  _chunkQYC7EATTjs.populateRSCRouteModules.call(void 0, globalVar.__reactRouterRouteModules, payload.matches);
  ...
  globalVar.__reactRouterDataRouter = _chunk7ALGNJXBjs.createRouter.call(void 0, {
    ...
    hydrationData: _chunkQYC7EATTjs.getHydrationData.call(void 0, {
      state: {
...
function RSCHydratedRouter({
  ...
  return /* @__PURE__ */ React3.createElement(_chunk7ALGNJXBjs.RSCRouterContext.Provider, { value: true }, /* @__PURE__ */ React3.createElement(_chunkQYC7EATTjs.RSCRouterGlobalErrorBoundary, { location: state.location }, /* @__PURE__ */ React3.createElement(_chunk7ALGNJXBjs.FrameworkContext.Provider, { value: frameworkContext }, /* @__PURE__ */ React3.createElement(
...
function createRouteFromServerManifest(match, payload) {
  ...
  _chunkQYC7EATTjs.populateRSCRouteModules.call(void 0, window.__reactRouterRouteModules, match);
  let dataRoute = {
    id: match.id,
...
function normalizeRedirectLocation(location2) {
  if (_chunk7ALGNJXBjs.PROTOCOL_RELATIVE_URL_REGEX.test(location2)) {
    let path = _chunk7ALGNJXBjs.resolvePath.call(void 0, location2);
