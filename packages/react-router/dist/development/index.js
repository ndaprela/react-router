...
var _chunkQYC7EATTjs = require('./chunk-QYC7EATT.js');
...
async function routeRSCServerRequest({
  ...
  try {
    ...
    if (serverResponse.status === _chunk7ALGNJXBjs.SINGLE_FETCH_REDIRECT_STATUS && payload.type === "redirect") {
      if (_chunk7ALGNJXBjs.hasInvalidProtocol.call(void 0, payload.location)) {
    ...
    if (renderRedirect) {
      if (_chunk7ALGNJXBjs.hasInvalidProtocol.call(void 0, renderRedirect.location)) {
        throw new Error("Invalid redirect location");
      }
        ...
        if (renderRedirect) {
          ...
          controller.enqueue(
            new TextEncoder().encode(
              `<meta http-equiv="refresh" content="0;url=${_chunk7ALGNJXBjs.escapeHtml.call(void 0, renderRedirect.location)}"/>`
            )
          );
        }
      }
    ...
    try {
      ...
      headers.set("Content-Type", "text/html; charset=utf-8");
      if (retryRedirect) {
        if (_chunk7ALGNJXBjs.hasInvalidProtocol.call(void 0, retryRedirect.location)) {
          throw new Error("Invalid redirect location");
        }
      ...
      const retryRedirectTransform = new TransformStream({
        flush(controller) {
          if (retryRedirect) {
            ...
            controller.enqueue(
              new TextEncoder().encode(
                `<meta http-equiv="refresh" content="0;url=${_chunk7ALGNJXBjs.escapeHtml.call(void 0, retryRedirect.location)}"/>`
              )
            );
          }
        }
...
function RSCStaticRouter({ getPayload }) {
  ...
  const frameworkContext = {
    ...
    routeModules: _chunkQYC7EATTjs.createRSCRouteModules.call(void 0, payload)
  };
  return /* @__PURE__ */ React3.createElement(_chunk7ALGNJXBjs.RSCRouterContext.Provider, { value: true }, /* @__PURE__ */ React3.createElement(_chunkQYC7EATTjs.RSCRouterGlobalErrorBoundary, { location: payload.location }, /* @__PURE__ */ React3.createElement(_chunk7ALGNJXBjs.FrameworkContext.Provider, { value: frameworkContext }, /* @__PURE__ */ React3.createElement(
    _chunkM7WNIC24js.StaticRouterProvider,
    {
      context,
      router,
